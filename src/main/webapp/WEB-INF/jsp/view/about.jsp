    ...
    <tiles:putAttribute name="body">
		<div class="about">
			...
			<p>	
				...
				The source code is available in <a href="https://github.com/dihaw-team/dihaw-wsdl-webservices" target="_blank">Github</a>.
			</p>
			...
			<ul>
				...
				<li>Go to http://localhost:port/dihaw-wsdl-webservices/</li>
				<li>The <strong>log</strong> will be created on the <em>C:/dihaw/logs/dihaw-wsdl-webservices/SystemOut.log</em> file (see the <strong>logback.xml</strong> file)</li>
			</ul>
			</br></br>  
		</div>
    </tiles:putAttribute>
